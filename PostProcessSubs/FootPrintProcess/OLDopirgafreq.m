 function [rat]=opirgafreq(u,lso,z_geom,TB,zbyl)
...
%lirga is the line averaging in the sensor-for LI7500 it is 0.15m
 % time constants  
 t1=0.127/(4*u); % line averaging for open path  (Horst 1997 & 2000)
   t2=lso/(8.4*u); % scalar flux line averaging
 t3=(0.2+0.4*0.01/0.127)*(0.127/u);%volume averaging-see massman 2000
 t4=0.016;% open path band width (Boundary layer meteorology , 82:219-233)
