...
% tsDatOut=[];
% for i=0:21
%     [tsData,tsHeaders,Var_names]=readTOB1(['C:\Users\thmorin\Desktop\testDrive\thmremote_ts_data_2019_07_02_' ...
%         num2str(i*100+59,'%04d') '.dat']);
%     tsDatOut=[tsDatOut;tsData];
% end

function [data,Header,Var_names,year,month,day,hour,minut,secon]=readTOB1(name)
fileID=fopen(name);
for i=1:5
